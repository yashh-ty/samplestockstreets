...
end_time = time.time()
print(f"Total rows inserted: {rows_inserted_bhavcopy}")
print(f"Time taken to execute the task: {end_time - start_time:.6f} seconds")
...
report_data_bhav = {
    "table_name": "stock_streets.bhavcopy",
    "rows_inserted": rows_inserted_bhavcopy,  # Example count based on typical daily bhavcopy volume
    "start_date": last_date_record, # Based on the last_date_record logic
    "end_date": datetime.datetime.now(),   # Current date in context
}
