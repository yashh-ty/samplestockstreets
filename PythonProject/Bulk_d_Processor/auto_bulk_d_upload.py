...
def fetch_bulk_data(start_date, end_date):
    ...
    url = f"https://www.nseindia.com/api/historicalOR/bulk-block-short-deals?optionType=bulk_deals&from={start_date}&to={end_date}&csv=true"
...
def insert_bulk_data(data):
    ...
    insert_query = '''
    INSERT INTO stock_streets.bulk_deal
    (DATE,SYMBOL,SECURITY_NAME,CLIENT_NAME,BUY_SELL,QTY,PRICE,REMARK)
