...
selectData= '''SELECT 
        'index_api_data' AS Table_Name, 
        MAX(created_at) AS Last_UPDATE, 
        COUNT(*) AS Total_rows 
    FROM stock_streets.index_api_data
    WHERE DATE(index_date) >= %s AND DATE(index_date)<= %s;'''
...
index_api_report_data=[[TABLENAME,ROWS_INSERTED,START_DATE,END_DATE,LAST_UPDATE,LOCALORVPS]]
